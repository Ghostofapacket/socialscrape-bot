...
# shamelessly taken from https://github.com/JustAnotherArchivist/little-things/blob/master/archivebot-jobid-calculation :-)
...
def jobid(url):
    #print(int_to_base36(jobidcalc(url)))
    result = int_to_base36(jobidcalc(url))
    return result
